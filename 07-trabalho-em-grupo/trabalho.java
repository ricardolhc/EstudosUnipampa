...
public class Main {
	public static void main(String[] args) {
		...
		int questoesCorretas; // CONTADOR DE RESPOSTAS CORRETAS
		int questoesErradas; // CONTADOR DE RESPOSTAS ERRADAS
		...
		do {
		    ...
		    escolha = input.nextLine(); //LER RESPOSTA DO USUÁRIO
		    
		    questoesCorretas = 0; // VALOR PADRÃO PARA AS RESPOSTAS CERTAS
		    questoesErradas = 0; // VALOR PADRÃO PARA AS RESPOSTAS ERRADAS
		    ...
		    switch(escolha) {
		        ...
		        case "a": case "A": // FILMES E SÉRIES
		            ...
		            System.out.println();
		            System.out.println("Total de acertos: " + questoesCorretas);
		            System.out.println("Total de erros: " + questoesErradas);

					switch(questoesCorretas) {
						case 0:
		        ...
		        case "d": case "D": //Java
		            ...
		            do {
		                if(!sair) {
    		                System.out.println();
    		                System.out.println("4. Qual a maneira correta de receber uma input do tipo char?");
    		                System.out.println("a) variavel = input.next().charAt();");
    		                System.out.println("b) variavel = input.next().charAt(0);"); //QUESTÃO CERTA
    		                System.out.println("c) variavel = input.next()charAt(0);");
    		                ...
    		                if(escolha.equals("b")) { // QUESTÃO CERTA É A ALTERNATIVA B
    		                    ...
    		                    System.out.println("Resposta errada! A maneira correta é variavel = input.next().charAt(0);.\n");
    		                    questoesErradas++;
    		                } else if (escolha.equals("e")) {
    		                    sair = true; // USUÁRIO QUER SAIR NO MEIO DA QUESTÃO
    		                } else {
